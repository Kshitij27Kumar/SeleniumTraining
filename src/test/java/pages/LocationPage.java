...
public class LocationPage extends baseTest {
	...
	By office_name= By.cssSelector("#name");
	By city_name=By.cssSelector("#city");
	By phone_no=By.cssSelector("#phone");
	By zip_code=By.cssSelector("#zipCode");
	String countryList="//ul[@id=\"select-options-844b3be1-6133-f984-6765-7371cc517eca\"]";
	String stateList="//*[@id=\"select-options-9681f5e0-53dd-8ab9-a254-271ad6868ea2";
	String country="//*[@id=\"countryCode_inputfileddiv\"]/div/input";
	String state="//*[@id=\"state_inputfileddiv\"]/div/input";
	...
	public void Details(String Office, String City,String Phone, String Zip, String Country,String State) throws InterruptedException {
		waitAndClick(addBtn);
		waitAndClick(office_name);
		driver.findElement(office_name).sendKeys(Office);
		...
		dropDown(stateList,state,State);
